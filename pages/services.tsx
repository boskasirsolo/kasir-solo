...
const WEBSITE_DATA = {
  features: [
    ...
    { title: "Google Maps Ready", desc: "Gratis setup Google Business Profile agar toko fisik Anda muncul di pencarian lokal (Maps).", icon: MapPin },
...
const WEBSITE_CALC: CalcData = {
  ...
  addons: [
    ...
    { id: 'gbp_setup', label: 'Setup Google Business Profile', price: 750000, desc: 'Verifikasi lokasi & optimasi profil.' },
...
const WEBAPP_DATA = {
  features: [
    ...
    { title: "Reputation Dashboard", desc: "Integrasi ulasan Google Maps langsung ke dashboard admin untuk pantau reputasi.", icon: Star },
...
const WEBAPP_CALC: CalcData = {
  ...
  addons: [
    ...
    { id: 'gbp_api', label: 'Integrasi Google Reviews', price: 1500000, desc: 'Tarik ulasan Maps ke Web/App.' },
...
const SEO_DATA = {
  features: [
    ...
    { title: "Map Pack Domination", desc: "Optimasi Google Business Profile agar toko Anda muncul di '3 Besar' peta lokal.", icon: MapPin },
    { title: "Dominasi Lokal (GMB)", desc: "Muncul di Google Maps saat orang mencari produk Anda di kota Anda.", icon: Anchor },
...
const SEO_CALC: CalcData = {
  ...
  addons: [
    { id: 'gmb_opt', label: 'Optimasi Google Maps (GMB)', price: 1500000, desc: 'Audit, Post, & Review Management.' },
