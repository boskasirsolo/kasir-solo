...
// --- TABLE 1: Top Pages ---
export const TopPagesTable = ({ pages }: { pages: [string, number][] }) => (
            ...
            <div className="space-y-4">
                <div className="p-4 bg-white/5 rounded-xl border border-white/5 flex items-center justify-between">
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-white">{bounceRate}%</h3>
                    </div>
                ...
                <div className="p-4 bg-white/5 rounded-xl border border-white/5 flex items-center justify-between">
                    <div>
                        ...
                        <h3 className="text-2xl font-bold text-white">{avgPages}</h3>
                    </div>
