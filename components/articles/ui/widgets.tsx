...
import { Search, Filter, FolderOpen, ChevronDown, ChevronRight, Flame, TrendingUp } from 'lucide-react';
...
export const CategorySidebar = ({ selectedFilter, onSelect }: { selectedFilter: FilterState, onSelect: (type: 'parent' | 'sub' | 'all', value: string) => void }) => {
